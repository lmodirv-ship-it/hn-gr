    ...
    <footer className="relative mt-24 border-t border-white/5 bg-background/40 backdrop-blur-xl">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-3"><h4 className="text-sm font-semibold">{t("footer.contact")}</h4><ul className="mt-4 space-y-3 text-sm text-muted-foreground"><li className="flex items-start gap-2"><Mail className="mt-0.5 h-4 w-4 text-primary" /><a href="mailto:lmdorv@gmail.com" className="hover:text-primary">lmdorv@gmail.com</a></li><li className="flex items-start gap-2"><Phone className="mt-0.5 h-4 w-4 text-primary" /><span>+33 1 23 45 67 89</span></li><li className="flex items-start gap-2"><MapPin className="mt-0.5 h-4 w-4 text-primary" /><span>{t("footer.location")}</span></li></ul></div>
        </div>
      </div>
