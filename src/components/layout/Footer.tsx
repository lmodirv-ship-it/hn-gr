      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <div className="mt-5 flex items-center gap-3">{[{ Icon: Twitter, href: "#", label: "Twitter" }, { Icon: Linkedin, href: "#", label: "LinkedIn" }, { Icon: Github, href: "#", label: "GitHub" }].map(({ Icon, href, label }) => <a key={label} href={href} aria-label={label} className="grid h-9 w-9 place-items-center rounded-md border border-border bg-surface/40 text-muted-foreground transition-all hover:border-primary/40 hover:text-primary"><Icon className="h-4 w-4" /></a>)}</div>
          </div>
          ...
          <div className="md:col-span-3"><h4 className="text-sm font-semibold">{t("footer.contact")}</h4><ul className="mt-4 space-y-3 text-sm text-muted-foreground"><li className="flex items-start gap-2"><Mail className="mt-0.5 h-4 w-4 text-primary" /><a href="mailto:lmodirv@gmail.com" className="hover:text-primary">lmodirv@gmail.com</a></li><li className="flex items-start gap-2"><Phone className="mt-0.5 h-4 w-4 text-primary" /><span>+33 1 23 45 67 89</span></li><li className="flex items-start gap-2"><MapPin className="mt-0.5 h-4 w-4 text-primary" /><span>{t("footer.location")}</span></li></ul></div>
        </div>
      </div>
